...
Repository Genesis Pipeline (repo-genesis) — IMPORTANT:
  ...
  8. Use a `publisher` node (inputs: [`n:spec`], label: `publish`) to read `requirements.md` and dynamically generate browser successor nodes for creating milestones and issues on GitHub.
